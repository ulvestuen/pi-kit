---
name: pdca
description: Drive a task to an explicit quality bar with a Plan-Do-Check-Act loop. Use when "done" is defined by criteria you can check and a single pass is unlikely to clear them — building a feature to spec, fixing a bug until tests pass, refactoring to a standard, or producing anything that must satisfy a checklist.
---
