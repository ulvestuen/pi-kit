<!--
  pdca project instructions snippet.
  ...
  repository. Trim it to taste. The pdca extension already injects a short
...
4. **ACT** — call `pdca_checkpoint`. Follow the returned AUTOMATED prompt:
...
Quick start: `/pdca <task>` opens and runs a loop end to end. Bare `/pdca`
